<?php
	if (isset($_GET["name"])){ # -> checks if the value is set in the array
		echo htmlentities($_GET["name"]);} # -> makes it so attackers wont be able to execute scripts within your input box (turns everything to string so <script> will be a string and not a working tag)
...
<body>
	...
	<form method="GET" action="GET_post1.php">
		<div class ="">
			<label>
